...
FINISH_PATTERNS = [
    # NOTE: r"\bFINISH\b" removed — it matched the English word "finish" in
    # VLM prose like "Wait for the advertisement to finish its countdown",
    # causing the wrapper to declare the task complete prematurely.
