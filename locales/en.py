STRINGS = {
    ...
    'proxy_cp_cfg_title':       '🎤 ClawProxy TTS Config',
    'proxy_cp_cfg_hint':        'Edit clawproxy TTS provider settings (config.toml). Deploy to /opt/clawproxy/ when done.',
    'proxy_cp_default_provider':'Default TTS Provider',
    'proxy_cp_default_voice':   'Default Voice',
    'proxy_cp_btn_load':        '📂 Load',
    'proxy_cp_btn_save':        '💾 Save',
    'proxy_cp_btn_deploy':      '🚀 Deploy',
    'proxy_cp_loaded':          '✅ Loaded from local config',
    'proxy_cp_saved_ok':        '✅ clawproxy config.toml saved',
    'proxy_cp_save_err':        '❌ Save failed: {}',
    'proxy_cp_deploy_ok':       '✅ Deployed to /opt/clawproxy/config.toml',
    'proxy_cp_deploy_err':      '❌ Deploy failed: {}',
    # ── Skills config ─────────────────────────────────────────────────────────
    ...
    'char_memory_warn':    '⚠ Overwrites current agent memory — check only if intentional',
